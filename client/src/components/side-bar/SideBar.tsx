    ...
    return (
        <div className="side-bar">
            <Modules
                ...
                onModuleClick={setActiveContent}
            />
            <ul className="side-bar-content">
                <li
                    className={`side-bar-item ${
                        activeContent === SIDEBAR_PAGE.FILE_EXPLORER
                ...
                <li
                    className={`side-bar-item ${
                        activeContent === SIDEBAR_PAGE.SEARCH
                            ? `side-bar-item-active`
                            : ``
                    }`}
                >
                ...
                <li
                    className={`side-bar-item ${
                        activeContent === SIDEBAR_PAGE.CONTACT_ME
                            ? `side-bar-item-active`
                            : ``
                    }`}
                >
                ...
                <li
                    className={`side-bar-item ${
                        activeContent === SIDEBAR_PAGE.TECHNOLOGIES
                            ? `side-bar-item-active`
                            : ``
                    }`}
                >
                ...
                <li
                    className={`side-bar-item ${
                        activeContent === SIDEBAR_PAGE.LOGIN
                            ? `side-bar-item-active`
                            : ``
                    }`}
                >
                ...
                <li
                    className={`side-bar-item ${
                        activeContent === SIDEBAR_PAGE.SITE_INFO
                            ? `side-bar-item-active`
                            : ``
                    }`}
                >
