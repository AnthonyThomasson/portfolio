    ...
    return (
        <div className="modules">
            <div className="top-modules">
                <button
                    className={`module ${
                        props.activeButton === SIDEBAR_PAGE.FILE_EXPLORER
                            ? 'active'
                            : ''
                    }`}
                    onClick={() =>
                        props.onModuleClick(SIDEBAR_PAGE.FILE_EXPLORER)
                    }
                >
                ...
                <button
                    className={`module ${
                        props.activeButton === SIDEBAR_PAGE.SEARCH
                            ? 'active'
                            : ''
                    }`}
                ...
                <button
                    className={`module ${
                        props.activeButton === SIDEBAR_PAGE.CONTACT_ME
                            ? 'active'
                            : ''
                    }`}
                ...
                <button
                    className={`module ${
                        props.activeButton === SIDEBAR_PAGE.TECHNOLOGIES
                            ? 'active'
                            : ''
                    }`}
                    onClick={() =>
                        props.onModuleClick(SIDEBAR_PAGE.TECHNOLOGIES)
                    }
                >
            ...
            <div className="bottom-modules">
                <button
                    className={`module ${
                        props.activeButton === SIDEBAR_PAGE.LOGIN
                            ? 'active'
                            : ''
                    }`}
                ...
                <button
                    className={`module ${
                        props.activeButton === SIDEBAR_PAGE.SITE_INFO
                            ? 'active'
                            : ''
                    }`}
