...
function file(props: Props) {
  ...
  return (
    <div className="system-node">
      <div
        className={`system-node-name ${node.selected === true ? 'system-node-name-selected' : ''}`}
        style={{
    ...
    <div className="system-node">
      <div
        className={`folder-guide ${
          hasSelectedChild === true ? 'folder-guide-contains-selected' : ''
        }`}
        style={
          node.open === false
            ? { display: 'none ' }
      ...
      <div className="system-node-content">
        ...
        >
          <span
            className={`chevron fa-solid ${node.open ? 'fa-chevron-down' : 'fa-chevron-right'}`}
          ></span>
